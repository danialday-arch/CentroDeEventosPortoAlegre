...
public class GlobalExceptionHandler {
    ...
    public Map<String, String> handleJsonMappingExceptions(HttpMessageNotReadableException ex) {
        ...
        if (cause instanceof InvalidFormatException) {
            ...
            errors.put("error_sintaxis", "Error de sintaxis en la peticion. Verifique el formato JSON, comillas faltantes o caracteres sueltos (fuera de comillas) o bien si el campo requeria un numero.");
            errors.put("posible causa", detalleExacto);     // es el detalle del error basicamente
